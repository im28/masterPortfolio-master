...
const greeting = {
	...
	resumeLink:
		"https://drive.google.com/open?id=11SU3OhrTlUFWC0LHFwV1xsbwdUd4SSII&authuser=fouad%40graduate.utm.my&usp=drive_fs"
};

const socialMediaLinks = {
	/* Your Social Media Link */
	github: "https://github.com/im28",
	linkedin: "https://www.linkedin.com/in/ibrahim-elshamandi/",
	gmail: "fouad@graduate.utm.my",
  ...
  degrees : [
    {
      ...
      subtitle: "Bachelor Of Computer Science (Graphics And Multimedia Software)",
      logo_path: "utm.png",
      alt_name: "UTM",
      duration: "2017 - Present",
      descriptions: [
        "⚡ Studied basic software engineering subjects like DS, Algorithms, DBMS, OS, CA, AI etc.",
        "⚡ Apart from this, Completed courses on Machine Learning, Data Science, Cloud Computing and Full Stack Development.",
        "⚡ Selected for Dean's List every semester"
      ],
      website_link: "http://utm.my"
    }
  ]
}
...
const contactInfo = {
  ...
  number: "+60-196149528",
  email_address: "fouad@graduate.utm.my"
};
